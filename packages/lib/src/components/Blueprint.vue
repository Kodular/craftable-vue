<template>
  <component :is="component" v-bind="$attrs" :draggable="true" @dragstart="handleDragStart" @dragend="handleDragEnd"
    @dragstart.native="handleDragStart" @dragend.native="handleDragEnd">
    <slot></slot>
  </component>
</template>
...
export default {
  ...
  methods: {
    handleDragStart(event) {
      ...
      const node = createNodeFromVNode(this.editor, this.$slots.default()[0]);
